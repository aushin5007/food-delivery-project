...
MySQL - 5.7.9 : Database - django_fooddelivery
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`django_fooddelivery` /*!40100 DEFAULT CHARACTER SET latin1 */;

USE `django_fooddelivery`;
...
('b3p72ggylgxvpmp5t4r06k65iozfn0qs','MGI3NDVhZjJjMjhkNWUwNjVjZGY3NzNjYmM1OTRkMjkwY2JmN2IxYTp7ImxvZ2luX2lkIjoxLCJwaWQiOjF9','2024-03-26 08:45:35.894240'),
('0udhfisl9orwvwsow5s3s3f8v8ioddpy','OWY2Nzk5NWM1YTEyMmFiMjcxNTNiYjE0NGMzYWMxNTY4MjRmZmYwYzp7ImxvZ2luX2lkIjo3LCJwaWQiOjF9','2024-03-26 14:33:09.470574'),
('mf1506ci2xfcmo2z6ayldo1556xzopsj','OWY2Nzk5NWM1YTEyMmFiMjcxNTNiYjE0NGMzYWMxNTY4MjRmZmYwYzp7ImxvZ2luX2lkIjo3LCJwaWQiOjF9','2024-03-26 15:15:49.699903'),
('vagedyneb83m0myev5l5lzv4844gcqtw','ZTkyODRkMDIzZmYzNDcxMzY4YzU2MTJlOTkxZTU2NGQwZGE5ZGI2ODp7ImxvZ2luX2lkIjo3LCJwaWQiOjEsImhpZCI6MX0=','2024-04-01 04:37:30.195711'),
('eu9z0nlsvbku5efixetn04098gys40jm','OTYwM2I0NDE1OWZjMDM2ZGFmZmFhZDg2ZDEwMDNiYjJmNmQwZTljZDp7ImxvZ2luX2lkIjoxfQ==','2024-04-09 08:07:22.257500'),
('ftyx71jnvmrxe41kippss5z0nz7ev1e0','OWY2Nzk5NWM1YTEyMmFiMjcxNTNiYjE0NGMzYWMxNTY4MjRmZmYwYzp7ImxvZ2luX2lkIjo3LCJwaWQiOjF9','2024-04-09 11:35:12.859620'),
('v1h8gp1d2do7nn3r66tr817o6lslahz7','YWU3YjIwY2Y2ZDUxZTAwZjZjNTE5OWE3YTkyNDNhOGRlZjQ0NGY4YTp7ImxvZ2luX2lkIjo5LCJoaWQiOjEsInBpZCI6MiwiZGJfaWQiOjJ9','2024-04-10 10:53:05.226918'),
('882ihgnbnlcyx2cmc0d7yo3v9jhr102u','MTYyOWZlZjM3YTIzMGY5ODczMGViZDQ1Y2Q0YWUzM2I1NGM3ODYzNjp7ImxvZ2luX2lkIjozLCJoaWQiOjF9','2024-05-03 03:55:21.738948'),
('2854bqw8teorlwv7y6xey0j4gfvr8our','ZTQwM2YyMGI4MDJmYjExY2VhZjI4ZjJjZDM2ZDFhNGI5NDdlMmNlYzp7ImxvZ2luX2lkIjoxMCwicGlkIjozfQ==','2024-05-09 10:11:16.189288');
...
(2,'5','<built-in method today of type object at 0x0000000076220740>','Delivery Completed',1,4,1,0),
(4,'2','2024-03-14','reject',1,4,1,1700),
(5,'5','2024-03-14','pending',1,4,1,4250),
(8,'1','2024-03-18','pending',1,5,1,850),
(9,'2','2024-03-26','pending',1,1,1,1700);
...
(2,'mohan','u','mm house','tvm','9099999900','mohann@gmail.com',1,8);
...
(1,'coffeee house','9867548692','coffee@gmail.com','active',3,1);
...
(4,'center','dboy','dboy'),
(9,'Aryaaa','Arya@123','user'),
(7,'M','M','user'),
(8,'Mohannn12','Mahann!234','dboy');
...
(2,'arya','p v','aryassss home','kannur','678999','female','22','9867548692','aryaa@gmail.com',9),
(3,'anjana','m','mm house','kochi','567785','female','50','9099999900','jhhjkj@gm.com',10);
...
/*Table structure for table `foodapp_payment_sub` */

DROP TABLE IF EXISTS `foodapp_payment_sub`;

CREATE TABLE `foodapp_payment_sub` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
...
/*Data for the table `foodapp_payment_sub` */

insert  into `foodapp_payment_sub`(`id`,`user_id`,`Amount`,`payment_date`,`payment_for`) values 
(2,1,'199','2024-03-27','subscription'),
(3,2,'199','2024-03-27','subscription'),
(4,2,'499','2024-03-27','subscription'),
(5,2,'499','2024-03-27','subscription'),
(6,2,'499','2024-03-27','subscription'),
(7,2,'499','2024-03-27','subscription'),
(8,3,'199','2024-04-25','subscription');
...
insert  into `foodapp_reported_hotel`(`id`,`reason_details`,`date_time`,`hotel_id`,`passenger_id`,`status`) values 
(1,'swd','2024-03-09',1,1,'Block'),
(2,'vhjvkbxsn','2024-03-11',1,1,'active'),
(3,'rrrrrrrr','2024-03-14',1,1,'active'),
(4,'r4r34','2024-03-14',1,1,'Block');
...
/*Table structure for table `foodapp_subscription` */

DROP TABLE IF EXISTS `foodapp_subscription`;

CREATE TABLE `foodapp_subscription` (
...
/*Data for the table `foodapp_subscription` */

insert  into `foodapp_subscription`(`subscription_id`,`amount`,`from_date`,`to_date`,`sub_status`,`user_id`) values 
(1,'199','2024-03-27','2024-06-25','subscribed',2),
(2,'199','2024-04-25','2024-07-24','subscribed',3);
